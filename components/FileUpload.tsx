  ...
  const processFile = (file: File) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        if (parsed.length === 0) {
          setError("No valid rows found. Check column headers: Student Name · District · School Name · County · Activity · Enrolled? · Total Classes · Total Attendance% · Attendance · Attendance last 5 sessions.");
          return;
        }
          ...
          <>
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-3 font-mono bg-muted px-2 py-1 rounded">
                Columns: Student Name · District · School Name · County · Activity · Enrolled? · Total Classes · Total Attendance% · Attendance · Attendance last 5 sessions
              </p>
            </div>
          </>
        )}
